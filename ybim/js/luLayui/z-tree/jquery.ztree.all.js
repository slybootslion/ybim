      ...
      view = {
        ...
        makeNodeIcoStyle: function (setting, node) {
          ...
          if (!node.isAjaxing) {
            var isParent = data.nodeIsParent(setting, node)
            var icon =
              isParent && node.iconOpen && node.iconClose ? (node.open ? node.iconOpen : node.iconClose) : node[setting.data.key.icon]
    ...
    var _consts = {
        ...
        onMousedownNode: function (eventMouseDown, _node) {
          ...
          function _docMouseMove(event) {
            ...
            if (root.dragFlag == 1) {
              ...
              if (tmpTarget && tmpTarget.attr('id') != targetSetting.treeId) {
                ...
                if (
                  tmpTarget &&
                  tools.apply(targetSetting.edit.drag.inner, [targetSetting.treeId, nodes, null], !!targetSetting.edit.drag.inner)
                ) {
          ...
          function _docMouseUp(event) {
            ...
            if (tmpTarget) {
              ...
              if (
                tools.apply(setting.callback.beforeDrop, [targetSetting.treeId, nodes, dragTargetNode, moveType, isCopy], true) ==
                false
              ) {
      ...
      _view = {
        ...
        moveNode: function (setting, targetNode, node, moveType, animateFlag, isSilent) {
          ...
          if (setting.data.keep.leaf && targetNode && !data.nodeIsParent(setting, targetNode) && moveType == consts.move.TYPE_INNER)
            return
